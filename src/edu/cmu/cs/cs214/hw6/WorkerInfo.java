...
public class WorkerInfo implements Serializable {
    ...
    private List<Partition> execuetePartitions;
    ...
    public WorkerInfo(String name, String host, int port, List<Partition> partitions) {
        ...
        execuetePartitions=new ArrayList<Partition>();
    }

    public List<Partition> getExecuetePartitions() {
		return execuetePartitions;
	}


	public void setExecuetePartitions(List<Partition> execuetePartitions) {
		this.execuetePartitions = execuetePartitions;
	}
